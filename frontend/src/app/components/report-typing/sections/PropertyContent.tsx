...
export default function PropertyContent({ state }: { state: ReportTypingState }) {
  const { result: r, valuer, updateValuer, aiSections, aiLoading, aiEditing, generateAiSection, saveAiEdit, setAiEditing, firmTemplate, setShowFirmSettings } = state
