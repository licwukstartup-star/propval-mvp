...
export default function InstructionsScopeContent({ state, page = 1 }: { state: ReportTypingState; page?: 1 | 2 }) {
  const { meta, updateMeta, valuer, updateValuer, firmTemplate, setShowFirmSettings, openFirmSettingsAt } = state
  ...
  return (
    <>
      {page === 1 && (
        <>
          <Sub num="1.1" title="Instructions" cats={["A", "B"]} onCatClick={c => handleCatClick(c, "1.1")}>
          ...
          <Sub num="1.2" title="Client" cats={["A", "B"]} onCatClick={c => handleCatClick(c, "1.2")}>
          ...
          <Sub num="1.7" title="Basis of Valuation" cats={["A", "E"]} onCatClick={c => handleCatClick(c, "1.7")}>
          ...
          <Sub num="1.8" title="Conflict of Interest" cats={["A", "E"]} onCatClick={c => handleCatClick(c, "1.8")}>
      ...
      {page === 2 && (
        <>
          <Sub num="1.9–1.11" title="Responsibility, Disclosure, PI Insurance" cats={["A"]} onCatClick={c => handleCatClick(c, "1.9–1.11")}>
          ...
          <Sub num="1.12" title="Expertise" cats={["A", "B"]} onCatClick={c => handleCatClick(c, "1.12")}>
          ...
          <Sub num="1.13" title="Inspection" cats={["A", "B"]} onCatClick={c => handleCatClick(c, "1.13")}>
